...
export const fetchAllPackages = async () => {
  ...
  if (
    dataCache.lastFetch &&
    Date.now() - dataCache.lastFetch < 300000 &&
    dataCache.Oasis1Packages.length > 0
  ) {
    return dataCache;
  }
  ...
  dataCache.loadPromise = (async () => {
    try {
      ...
      console.log("✅ Packages loaded:", {
        oasis1: oasis1Packages.length,
        oasis2: oasis2Packages.length,
      });
...
export const BOOKING_RULES = [
  {
    title: "Downpayment",
    desc: "₱3,000 for Day/Night · ₱5,000 for 22-hour packages (non-refundable)",
  },
  {
    title: "Incidental Fee",
    desc: "₱1,000 collected before check-in, refundable upon checkout",
  },
  {
    title: "Extra Person",
    desc: "₱150 per person beyond the package capacity",
  },
  {
    title: "Check-in / Check-out",
    desc: "Check-in: 8:00 AM · Check-out: 6:00 PM",
  },
  {
    title: "Rescheduling",
    desc: "Allowed at least 1 week before booking date",
  },
  {
    title: "Valid ID Required",
    desc: "Present 1 valid government-issued ID upon arrival",
  },
];
