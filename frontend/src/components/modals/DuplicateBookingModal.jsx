// frontend/src/components/modals/DuplicateBookingModal.jsx

import React from 'react';

const DuplicateBookingModal = ({ isOpen, onClose, onViewBookings }) => {
    ...
    >
      ...
      >
        <div style={{ padding: '24px', textAlign: 'center' }}>
          ...
          >
            <i className="fas fa-calendar-times" style={{ color: '#dc2626', fontSize: '28px' }}></i>
          </div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
              ...
              <span style={{ fontSize: '13px', color: '#475569' }}>You can only have one booking per date</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <i className="fas fa-calendar-alt" style={{ color: '#0284c7', width: '18px' }}></i>
              <span style={{ fontSize: '13px', color: '#475569' }}>Select a different date to continue</span>
            </div>
          </div>
        </div>
